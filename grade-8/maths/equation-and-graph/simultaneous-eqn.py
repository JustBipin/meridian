...
class SimultaneousEquations(Scene):
    ...
    def construct(self):
        ...
        ex_eq1[0].set_color(TEAL); ex_eq1[1].set_color(INK); ex_eq1[2].set_color(PINK); ex_eq1[3].set_color(INK); ex_eq1[4].set_color(INK)
        
        ex_eq2 = MathTex("x", "-", "y", "=", "2").scale(1.2)
        ex_eq2[0].set_color(TEAL); ex_eq2[1].set_color(INK); ex_eq2[2].set_color(PINK); ex_eq2[3].set_color(INK); ex_eq2[4].set_color(INK)
        ...
        ex_axes = Axes(x_range=[0, 8, 2], y_range=[0, 8, 2],
                       x_length=4.0, y_length=4.0, tips=False,
