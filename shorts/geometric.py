...
class GeometricSeriesCute(Scene):
    def construct(self):
        ...
        self.camera.background_color = "#F7F4EF"
        ...
        bright_colors = [
            ...
            "#FFC8DD",  # pastel pink
            "#95D5B2",  # mint green
            "#A2D2FF",  # bright baby blue
            "#F28482",  # coral
            "#B8A0D9",  # soft purple
            "#72D6C9",  # vibrant pastel teal
            "#FFB4A2",  # salmon
            "#89B4E8",  # periwinkle blue
            "#E8A0BF",  # dusty pink
            "#A8CFA8",  # soft green
            "#F6BD60",  # warm peach
            "#9AD1D4",  # aqua
            "#D5A6E6",  # bright lavender
            "#FF8FA3",  # rose pink
            "#8EC5E8",  # soft blue
            "#B5E2A8",  # fresh green
            "#F4A6A6",  # pastel coral
            "#A9B5E8",  # blue-lavender
            "#F7C59F",  # warm peach
        ]
        text_color = "#202124"
        frame_color = "#202124"
        ...
        # ...
        #
        # Every rectangle stays inside the unit square.
        # ============================================================
        ...
        # OUTER UNIT SQUARE
        #
        # Appears ONLY after all rectangles are assembled.
        # ============================================================
